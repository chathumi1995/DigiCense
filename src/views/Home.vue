<template>
  <div>
    ...
    <!-- know more about digicense -->
    <div class="about-us py-5" id="about-us">
      <div class="container mt-5">
        <div class="row">
          <div class="col-md-6">
            ...
            <button type="button" class="btn btn-warning">Let's Know More</button>
          </div>
          <div class="col-md-6">
            <img
    ...
    <!-- parallax -->
    <v-parallax light src="https://i.ibb.co/9sfxYzL/a1.jpg">
